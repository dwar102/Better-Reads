...
public interface UserDAO extends GenericDAO<User> {
	...
	Set<User_Media_Comments> getCommentsForMedia(Integer id);
	Set<User_Review_Comments> getCommentsForReview(Integer id);
	User_Review_Comments placeCommentForReview(User_Review_Comments c);
	User_Media_Comments placeCommentForMedia(User_Media_Comments c);
}
